                      ...
                      <TableBody>
                        {produtos.map((row) => (
                          <TableRow key={row._id}>
                            ...
                            {/*<TableCell align="center"><Chip label={getNomeTipo(row.preco_produto)} color={getNomeTipoLabel(row.preco_produto)}/></TableCell>
                            //<TableCell align="center">{new Date(row.preco_produto).toLocaleString('pt-br')}</TableCell> */}
                            <TableCell align="center">R$ {row.preco_produto}</TableCell>
                            <TableCell align="center">{formateDate(row.createdAt)}</TableCell>
                            <TableCell align="right">
                            <ButtonGroup aria-label="outlined primary button group">
                              <Button variant="contained" color="primary" href={'/admin/produtos/editar/'+row._id}><AutorenewIcon /> </Button>
